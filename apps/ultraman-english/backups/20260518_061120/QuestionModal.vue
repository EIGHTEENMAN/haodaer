  ...
  <div class="question-overlay" @click.self="() => {}">
    <div class="question-box">
      <div class="word-display">
        ...
        <div class="meaning-hint" v-if="skillName === 看">选择正确的中文释义</div>
        <div class="meaning-hint" v-else-if="skillName === 听">输入你听到的单词</div>
        <div class="meaning-hint" v-else-if="skillName === 说">读出这个单词</div>
        <div class="meaning-hint" v-else-if="skillName === 拼">补全单词</div>
        <div class="meaning-hint" v-else>选择正确的词填入句子</div>
      </div>
...
function onWrong() {
  ...
  feedback.value = { type: "wrong", text: "✗ 再想想!" }
